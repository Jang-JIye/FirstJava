...
public class Arr05 {
    public static void main(String[] args) {
        ...
        //기본형 변수 vs 참조형 변수
        // 1. 기본형 변수는 '소문자로 시작'함 반면, 참조형 변수는 '대문자로 시작'함
        // - Wrapper class에서 기본형 변수를 감싸줄 때 (boxing), int -> Integer
        // 2. 기본형 변수는 값 자체를 저장, 참조형 변수는 별도의 공간에 값을 저장 후 그 주소를 저장함 (= 주소형 변수)

        //char < String(훨씬 더!)
        //String이 ㅏ지고 있는 기능이 너무 많아서..!!!
        //Wrapper class와도 상당히 비슷..! -> 기본형 변수가 가지고 있는 기능이 제한 -> 다양한 기능을 제공하는 Wapper을 감쌈으로써 추가기능을 더함
        ...
        // (5) toSharArray() : string -> char[]
        char[] strSharArray = str.toCharArray();
